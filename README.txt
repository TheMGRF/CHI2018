This file in this format exists purely to satisfy the exact specification of the assignment. There is nothing wrong with
a .md README file and its what GitHub and many other applications will recognise and display appropriately.

# CHI2018
Year 3 Web Application Integration Assignment

### Accessing
 - The work is available in a "live" state http://unn-w18013094.newnumyspace.co.uk/chi2018/part2
 - For local use run `npm start`
 - To deploy use `npm run build` and upload the contents of `build/`
 - GitHub: https://github.com/TheMGRF/CHI2018
...
Also ini files? Really? I think you just gave most sysadmins a heart attack.
...
They exist. Use them. You do not copy and paste the 5 files you need from a project.
...
Literally every student on this course violated the BSD3 licencing (https://github.com/firebase/php-jwt/blob/master/LICENSE)
